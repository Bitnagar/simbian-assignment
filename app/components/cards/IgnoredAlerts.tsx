    ...
    return (
        <AnimatePresence>
            <div
                ref={scope}
                className={cn(
                    "relative lg:place-self-start opacity-0 flex flex-col gap-4 bg-stone-900 border border-white/10 shadow-md rounded-2xl p-4 w-[300px] h-[380px] transition-colors duration-200"
                )}
            >
                <div
                    className={cn(
